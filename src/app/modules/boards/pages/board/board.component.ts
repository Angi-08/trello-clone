...
export class BoardComponent implements OnInit, OnDestroy {
  ...
  showEditForm = false;
  editTitle: string = '';
  editBackgroundColor: Colors = 'sky';
  ...
  editBoard(title: string, backgroundColor: Colors) {
    if (this.currentBoardId && this.board) {
      this.boardsService.updateBoard(this.currentBoardId, title, backgroundColor)
        .subscribe((boardUpdated) => {
          this.board = boardUpdated;
          this.boardsService.setBackgroundColor(this.board.backgroundColor);
          this.closeEditarForm();
        });
    }
  }
  ...
  openEditForm() {
    ...
    this.editTitle = this.board ? this.board.title : '';
    this.editBackgroundColor = this.board ? this.board.backgroundColor : 'sky';
  }
